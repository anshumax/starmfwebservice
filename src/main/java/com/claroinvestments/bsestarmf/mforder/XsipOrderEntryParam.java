...
public class XsipOrderEntryParam {
    ...
    @XmlElement(name = "Brokerage", nillable = true)
    ...
    @XmlElement(name = "XsipRegID", nillable = true)
    protected String xsipRegID;
     ...
     *     
     */
    public void setXsipRegID(String value) {
        this.xsipRegID = value;
    }
