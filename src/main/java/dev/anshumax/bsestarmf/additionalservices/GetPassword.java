...
@XmlRootElement(name = "getPassword", namespace = "http://www.bsestarmf.in/2016/01/")
public class GetPassword {

    @XmlElement(name = "UserId", namespace = "http://www.bsestarmf.in/2016/01/", nillable = true)
    protected String userId;
    @XmlElement(name = "MemberId", namespace = "http://www.bsestarmf.in/2016/01/", nillable = true)
    protected String memberId;
    @XmlElement(name = "Password", namespace = "http://www.bsestarmf.in/2016/01/", nillable = true)
    protected String password;
    @XmlElement(name = "PassKey", namespace = "http://www.bsestarmf.in/2016/01/", nillable = true)
